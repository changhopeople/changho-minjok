    ...
    <section className="py-16 md:py-24 bg-gray-50">
      <div className="container mx-auto px-4">
        <AnimatedSection className="mb-12">
          <p className="text-[#EF4444] text-sm font-bold tracking-widest mb-4">
            TRUSTED PARTNERS
          </p>
        ...
        <AnimatedSection delay={0.2}>
          <div className="bg-white rounded-2xl p-6 border-2 border-[#EF4444]/30 mb-8">
            <h3 className="text-[#EF4444] font-bold text-lg mb-2">
              대기업 수준의 품질
            </h3>
