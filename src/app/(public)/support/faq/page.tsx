    ...
    items: [
      {
        ...
        answer: '전화(1668-1453) 또는 카카오톡으로 무료 상담을 신청하실 수 있습니다. 정확한 견적을 위해서는 무료 현장 방문 상담을 신청해주세요.',
      },
      {
      ...
      },
      {
        ...
        answer: '창호 가격은 프레임 종류(PVC, 알루미늄, 시스템), 유리 사양, 창문 크기 및 개수, 철거 범위 등에 따라 달라집니다. 정확한 가격은 현장 실측 후 안내드립니다.',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        answer: '제품 및 시공에 대해 기본 2년 무상 A/S를 제공하며, 제품 자체 결함에 대해서는 10년 이상 품질을 보증합니다.',
      },
      {
